...
public class JdbcSshDriverTest {
	...
	private void startupDerby() throws Exception {
		...
		dbServerDerby = new NetworkServerControl(InetAddress.getByAddress(null, new byte[]{127, 0, 0, 1}), DERBY_PORT);
	...
	private static class CommandFactory implements org.apache.sshd.server.CommandFactory, Factory<Command> {
